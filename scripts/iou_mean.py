...
This tool calculates a mean image IoU score 
using a formula: 1/n * sum (intersection / union).
"""
...
class SegmentationResultsProcessor:
    ...
    def process(self):
        """
        Processes the given set of images and returns a mean IoU score.
